...
const { createBusiness, getMyBusiness, getBusinessBySlug, getBusinessesByCity, getAllBusinesses, updateBusiness, getQRCode, getBusinessStats, getBusinessAnalytics, getBusinessLeaderboard } = require('../controllers/businessController');
...
router.get('/:id/analytics', authenticate, requireRole('business_owner'), getBusinessAnalytics);
